...
<head>
	...
	<link href="assets/css/complainer_page.css" rel="stylesheet" type="text/css" media="all" />
	...
	<div class="center-container">
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				<form action="#" method="post" style="color: gray">NID
					<input type="text"  name="nid_number" placeholder="NID Number" required="" disabled value=<?php echo "$a_no"; ?>>
